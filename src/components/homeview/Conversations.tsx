...
const Conversations = () => {
    ...
    return (
        <div className="min-h-[96vh] min-w-[25%] flex flex-col items-center bg-white 
            p-2 rounded-xl border border-gray-200 shadow-sm">

            <div className="flex flex-row items-center p-2 self-start w-full">
